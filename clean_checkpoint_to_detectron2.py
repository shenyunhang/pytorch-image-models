...
parser.add_argument('--output', default='', type=str, metavar='PATH',
                    help='output path')
parser.add_argument('--use-ema', dest='use_ema', action='store_true', default=False,
                    help='use ema version of weights if present')
parser.add_argument('--clean-aux-bn', dest='clean_aux_bn', action='store_true', default=True,
...
def main():
    ...
    if args.checkpoint and os.path.isfile(args.checkpoint):
        ...
        try:
            ...
            torch.save(checkpoint, _TEMP_NAME)
